...
<style>
  ...
  .btn   { height: 36px; border: 3px solid #000; padding: 0 16px; background: #fff; cursor: pointer; }
...
<body>
  ...
  <form method="get" action="${pageContext.request.contextPath}/search" class="row">
    <input class="input" type="text" name="productName" placeholder="輸入商品關鍵字（例：球鞋）" value="${fn:escapeXml(productName)}" />
